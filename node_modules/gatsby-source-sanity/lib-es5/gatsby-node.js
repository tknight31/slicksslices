...
var errorMap_1 = require("./util/errorMap");
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            ...
            if (reporter.setErrorMap) {
                reporter.setErrorMap(errorMap_1.ERROR_MAP);
            }
            return [2 /*return*/];
        });
    });
};
exports.onPreBootstrap = function (args, pluginOptions) { return __awaiter(void 0, void 0, void 0, function () {
    var config, reporter, actions, unsupportedVersionMessage, client, api, graphqlSdl, graphqlSdlKey, typeMap, typeMapKey, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                config = __assign(__assign({}, defaultConfig), pluginOptions);
                reporter = args.reporter, actions = args.actions;
                if (!actions.createTypes) {
                    unsupportedVersionMessage = oneline(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    You are using a version of Gatsby not supported by gatsby-source-sanity.\n    Either upgrade gatsby to >= 2.2.0 or downgrade to gatsby-source-sanity@^1.0.0"], ["\n    You are using a version of Gatsby not supported by gatsby-source-sanity.\n    Either upgrade gatsby to >= 2.2.0 or downgrade to gatsby-source-sanity@^1.0.0"])));
                    reporter.panic({
                        id: errorMap_1.prefixId(errorMap_1.CODES.UnsupportedGatsbyVersion),
            ...
            case 4:
                ...
                if (err_1.isWarning) {
                    ...
                    reporter.panic({
                        id: errorMap_1.prefixId(errorMap_1.CODES.SchemaFetchError),
                        context: { sourceMessage: err_1.stack },
                    }, err_1.stack);
                }
                return [3 /*break*/, 5];
...
exports.createResolvers = function (args, pluginOptions) {
...
exports.sourceNodes = function (args, pluginConfig) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                actions = args.actions, getNode = args.getNode, createNodeId = args.createNodeId, createContentDigest = args.createContentDigest, reporter = args.reporter, webhookBody = args.webhookBody;
            ...
            case 4:
                ...
                if (watchMode) {
                    ...
                    client
                        ...
                        .subscribe(function (event) { return handleListenerEvent_1.handleListenerEvent(event, publishedNodes, args, processingOptions); });
                }
...
function validateConfig(config, reporter) {
    if (!config.projectId) {
        reporter.panic({
            id: errorMap_1.prefixId(errorMap_1.CODES.MissingProjectId),
            context: { sourceMessage: '[sanity] `projectId` must be specified' },
        }, new Error('[sanity] `projectId` must be specified'));
    }
    if (!config.dataset) {
        reporter.panic({
            id: errorMap_1.prefixId(errorMap_1.CODES.MissingDataset),
