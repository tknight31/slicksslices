...
function processDocument(doc, options) {
    ...
    var node = __assign(__assign(__assign({}, withRefs), rawAliases), { id: documentIds_1.safeId(overlayDrafts ? unprefixDraftId_1.unprefixDraftId(doc._id) : doc._id, createNodeId), children: [], internal: {
