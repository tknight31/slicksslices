...
exports.getConflictFreeFieldName = exports.getTypeName = exports.processDocument = exports.RESTRICTED_NODE_FIELDS = void 0;
...
function processDocument(doc, options) {
    ...
    const node = Object.assign(Object.assign(Object.assign({}, withRefs), rawAliases), { id: documentIds_1.safeId(overlayDrafts ? unprefixDraftId_1.unprefixDraftId(doc._id) : doc._id, createNodeId), children: [], internal: {
