...
const errorMap_1 = require("./util/errorMap");
...
exports.createResolvers = (args, pluginOptions) => {
...
exports.sourceNodes = async (args, pluginConfig) => {
    ...
    if (watchMode) {
        ...
        client
            ...
            .subscribe((event) => handleListenerEvent_1.handleListenerEvent(event, publishedNodes, args, processingOptions));
    }
